...
class ProductSeeder extends Seeder
{
    public function run(): void
    {
        ...
        Product::create([
            ...
            "description" =>
                "Professional high-performance combi oven equipped with a state-of-the-art operating system and intelligent technology designed to perfectly handle any gastronomy, pastry and bakery cooking process.",
            "short_description" =>
                '10 trays GN 1/1 countertop combi oven with 16" touch panel.',
        ...
        Product::create([
            ...
            "description" =>
                "Professional high-performance combi oven equipped with a state-of-the-art operating system and intelligent technology designed to perfectly handle any gastronomy, pastry and bakery cooking process.",
            "short_description" =>
                '6 trays GN 1/1 countertop combi oven with 16" touch panel.',
            "type" => "Commercial countertop combi ovens",
            "panel" => '16" Touch control panel',
            "power_supply" => "Electric",
            "width" => 750.0,
