...
class FaqSeeder extends Seeder
{
    public function run(): void
    {
        $faqs = [
            ...
            // Ordering (sort 10–40)
            ['Ordering', 10, 'How do I place an order for a Kitchen oven?', 'You can configure and order your oven through our online configurator, contact our sales team via our contact page, or reach out to an authorized Kitchen dealer in your region.'],
            ...
            ['Warranty', 30, 'How do I file a warranty claim?', 'Contact Kitchen support via email or our contact form with your oven serial number and a description of the issue. Our support team will diagnose the problem and dispatch a technician if needed.'],
