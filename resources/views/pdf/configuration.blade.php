...
<head>
    <meta charset="UTF-8">
    <title>Your configuration - UNOX</title>
    <style>
        @page {
            margin: 15mm 20mm;
        }
...
<body>
    ...
    <div class="page">
        ...
        <div class="disclaimer-box">
            ...
            *Images and photographs in the configurator may not reflect the actual appearance of the finished product. The factory reserves the right to make changes to product prices, colors, materials, construction and equipment without prior notice. To find out the exact specifications of each item you can contact Unox Customer Service.<br><br>
            This document is provided for informational purposes only and does not constitute a final order confirmation. The generated document is subject to review and confirmation by the UNOX back office team. Kindly contact the back office responsible for your reference market or your sales representative in order to proceed with the order.
        </div>

        <div class="promo-box">
            <h3>Individual Cooking Experience</h3>
            <p>Go beyond the classic demo and try the oven for yourself. It's free! One of our experienced UNOX Active Marketing Chefs will be by your side to answer your questions and help you make the right choice for your business. Book your Individual Cooking Experience now!</p>
        </div>

        <div style="margin-top: 40px; font-size: 8pt; color: #888;">
            <strong>Unox S.p.a.</strong><br>
    ...
    <div class="page">
        ...
        <div class="disclaimer-box" style="margin-top: 25px;">
            ...
            Prices are estimates and may vary. This document is provided for informational purposes only and does not constitute a final order confirmation. Contact UNOX Customer Service or your sales representative for a formal quote.
        </div>
