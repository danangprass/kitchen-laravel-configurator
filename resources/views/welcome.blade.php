{{--
  ...
  Premium industrial feel — dark + gold, generous rounding, data-driven sections
--}}
...
<x-layouts.home>
    ...
    {{-- ═══════════════════════════════════════════
    HERO SECTION
    Dark overlay with gold accent, large display heading, premium industrial vibe
    ═══════════════════════════════════════════ --}}
    <section class="relative bg-midnight-500 min-h-[85vh] flex items-center overflow-hidden">
        {{-- Subtle radial glow behind hero --}}
        <div class="absolute inset-0 pointer-events-none" aria-hidden="true">
            <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2
                        w-[800px] h-[800px] rounded-full bg-gold-500/5 blur-3xl"></div>
        </div>

        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
            <div class="max-w-3xl">
                {{-- Eyebrow — uppercase gold label --}}
                <span class="inline-block text-gold-500 font-semibold text-xs tracking-widest uppercase mb-6">
                ...
                <div class="flex flex-wrap gap-4">
                    ...
                    <a href="/calculator"
                       class="inline-flex items-center px-8 py-3.5 rounded-button text-sm font-semibold
                              border-2 border-white/20 text-white hover:border-gold-500 hover:text-gold-500
                ...
                <div class="mt-16 flex flex-wrap items-center gap-8 text-sm text-white/40">
                    <span class="flex items-center gap-2">
                        <span class="w-8 h-8 rounded-full bg-gold-500/10 flex items-center justify-center">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
                ...
                <div>
                    ...
                    <a href="/about"
                       class="inline-flex items-center gap-2 text-gold-600 hover:text-gold-500 font-semibold text-sm
                ...
                <div class="grid grid-cols-2 gap-6">
                    <div class="bg-white rounded-card p-6 border border-steel-500/50 shadow-sm">
                        <div class="text-3xl font-display font-bold text-gold-500 mb-1">25+</div>
                        <div class="text-sm text-charcoal-400">Years Engineering<br> Experience</div>
                    </div>
                    <div class="bg-white rounded-card p-6 border border-steel-500/50 shadow-sm">
                        <div class="text-3xl font-display font-bold text-gold-500 mb-1">500+</div>
                        <div class="text-sm text-charcoal-400">Installations<br> Worldwide</div>
                    </div>
                    <div class="bg-white rounded-card p-6 border border-steel-500/50 shadow-sm">
                        <div class="text-3xl font-display font-bold text-gold-500 mb-1">98%</div>
                        <div class="text-sm text-charcoal-400">Client Retention<br> Rate</div>
                    </div>
                    <div class="bg-white rounded-card p-6 border border-steel-500/50 shadow-sm">
                        <div class="text-3xl font-display font-bold text-gold-500 mb-1">24/7</div>
    ...
    <section class="py-16 lg:py-24 bg-ice-500">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center max-w-2xl mx-auto mb-14 lg:mb-20">
                <span class="text-gold-600 font-semibold text-xs tracking-widest uppercase">
                    Core Equipment
                </span>
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-card border border-steel-500/30 p-8
                    ...
                    <div class="w-14 h-14 rounded-2xl bg-gold-500/10 flex items-center justify-center mb-6
                    ...
                    <a href="/products/deck-ovens"
                       class="inline-flex items-center gap-1.5 text-gold-600 hover:text-gold-500 font-semibold text-sm
    ...
    <section class="py-16 lg:py-24 bg-midnight-500 relative overflow-hidden">
        {{-- Background accent --}}
        <div class="absolute top-0 right-0 w-96 h-96 bg-gold-500/5 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2"
             aria-hidden="true"></div>

        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-14 lg:mb-20">
                <span class="text-gold-500 font-semibold text-xs tracking-widest uppercase">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                ...
                <div class="text-center">
                    <div class="text-5xl lg:text-6xl font-display font-extrabold text-gold-500 mb-2">
    ...
    {{-- ═══════════════════════════════════════════
    CTA BANNER
    "Build Your Configuration" — dark card with gold CTA
    ═══════════════════════════════════════════ --}}
    <section class="py-16 lg:py-24 bg-warm-white-500">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="bg-midnight-500 rounded-card p-10 lg:p-16 text-center relative overflow-hidden">
                ...
                <div class="absolute bottom-0 left-1/2 -translate-x-1/2 w-96 h-48
                            bg-gold-500/10 rounded-full blur-3xl pointer-events-none"
                     aria-hidden="true"></div>
    ...
    <section class="py-16 lg:py-24 bg-ice-500">
        <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <form action="/subscribe" method="POST"
                ...
                <button type="submit"
                        class="h-[55px] px-8 rounded-button bg-gold-500 text-midnight-500
                               font-semibold text-sm hover:bg-gold-600
                               transition-all duration-300 shadow-sm shadow-gold-500/25
            ...
            <p class="text-xs text-charcoal-300 mt-4">
                ...
                <a href="{{ route('privacy-policy') }}" class="text-gold-600 hover:text-gold-500 underline">Privacy Policy</a>.
            </p>
        </div>
    </section>
