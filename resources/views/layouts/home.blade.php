...
<body class="antialiased">
    ...
    <header class="sticky top-0 z-50 bg-midnight-500/95 backdrop-blur border-b border-white/5"
        ...
        <div x-show="mobileOpen"
             ...
             class="lg:hidden border-t border-white/10 bg-midnight-500">
                ...
                <div>
                    ...
                    <div class="flex items-center gap-3">
                        @if (config('contact.social.facebook'))
                            <a href="{{ config('contact.social.facebook') }}"
                               target="_blank" rel="noopener noreferrer"
                               aria-label="Facebook"
                               class="w-9 h-9 flex items-center justify-center rounded-lg bg-white/10
                        ...
                        @if (config('contact.social.instagram'))
                            <a href="{{ config('contact.social.instagram') }}"
                               target="_blank" rel="noopener noreferrer"
                ...
                <div>
                    ...
                    <ul class="space-y-2.5 text-sm text-white/60">
                        ...
                        <li class="flex items-start gap-2">
                            ...
                            <a href="tel:{{ preg_replace('/\s+/', '', config('contact.phone')) }}"
                               class="hover:text-white transition-colors duration-200">
