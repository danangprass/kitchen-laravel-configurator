@php
    ...
    $iconMap = [
        ...
        'chip' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M9 3v2m6-2v2M9 19v2m6-2v2M5 9H3m2 6H3m18-6h-2m2 6h-2M7 19h10a2 2 0 002-2V7a2 2 0 00-2-2H7a2 2 0 00-2 2v10a2 2 0 002 2zM9 9h6v6H9V9z"/>',
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach ($items as $item)
                    <div class="group bg-white rounded-card border border-steel-500/30 p-8
                                transition-all duration-300 hover:-translate-y-1
                                hover:shadow-xl hover:shadow-midnight-500/5">
                        @if (!empty($item['icon']))
                            <div class="w-14 h-14 rounded-2xl bg-midnight-500/10 flex items-center justify-center mb-5
                        ...
                        @endif
                        <h3 class="font-display font-bold text-lg text-midnight-500 mb-2.5">{{ $item['title'] ?? '' }}</h3>
